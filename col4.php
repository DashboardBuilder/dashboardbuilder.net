...
<div class="panel panel-default">
	...
	<button type="submit" class="close" ><div class="fa fa-gear"></div></button>
	 ...
	 if ($xmlDoc->col0->dbconnected== '1'){
	  ...
	  ?>
		<a data-toggle="modal" class="close" aria-label="Close" href="dbsetting.php?layout=4&col=0" data-target="#dbModal-0"><?php echo $connectionstatus;?></a>
	</div>
...
<div class="panel panel-default">
	...
	<?php
	 ...
	 if ($xmlDoc->col1->dbconnected== '1'){
	  ...
	  ?>
		<a data-toggle="modal" class="close" aria-label="Close" href="dbsetting.php?layout=4&col=1" data-target="#dbModal-1"><?php echo $connectionstatus;?></a>
	</div>
	<div class="panel-body result">
			<?php echo $result[1];?>
	</div>
...
<div class="panel panel-default">
	...
	<button type="submit" class="close" ><div class="fa fa-gear"></div></button>
	 ...
	 if ($xmlDoc->col2->dbconnected== '1'){
	  ...
	  ?>
		<a data-toggle="modal" class="close" aria-label="Close" href="dbsetting.php?layout=4&col=2" data-target="#dbModal-2"><?php echo $connectionstatus;?></a>
	</div>
	<div class="panel-body result">
			<?php echo $result[2];?>
	</div>
...
<div class="panel panel-default">
	...
	<button type="submit" class="close" ><div class="fa fa-gear"></div></button>
	 ...
	 <?php
	 $connectionstatus='<sub><div class="fa fa-close" style="color:#FF0000;" ></div></sub><div class="fa fa-database"></div>';
	 if ($xmlDoc->col3->dbconnected== '1'){
	 	$connectionstatus='<sub><div class="fa fa-check" style="color:#009933;" ></div></sub><div class="fa fa-database"></div>';
		}

		if ($xmlDoc->col3->source== 'upload'){
			if (file_exists($xmlDoc->col3->file)) {
				$connectionstatus='<div class="fa fa-file-excel-o" style="color:#669933;"></div>';
			}
		}
	  ?>
		<a data-toggle="modal" class="close" aria-label="Close" href="dbsetting.php?layout=4&col=3" data-target="#dbModal-3"><?php echo $connectionstatus;?></a>
	</div>
	<div class="panel-body result">
			<?php echo $result[3];?>
	</div>
	<!-- Modal -->
	<div class="modal fade" id="dbModal-3" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
		<div class="modal-dialog">
			<div class="modal-content">
			</div> <!-- /.modal-content -->
		</div> <!-- /.modal-dialog -->
	...
	<!-- Modal -->
	<div class="modal fade in" id="settingModal-3" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
		<div class="modal-dialog modal-lg">
			<div class="modal-content">
			<?php
			if (isset($_POST['node'])){
