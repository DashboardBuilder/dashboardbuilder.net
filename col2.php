...
<div class="panel panel-default">
	...
	<?php
	 ...
	 if ($xmlDoc->col0->dbconnected== '1'){
	  ...
	  ?>
		<a data-toggle="modal" class="close" aria-label="Close" href="dbsetting.php?layout=2&col=0" data-target="#dbModal-0"><?php echo $connectionstatus;?></a>
	</div>
...
<div class="panel panel-default">
	...
	<button type="submit" class="close" ><div class="fa fa-gear"></div></button>
		...
		<!--<a data-toggle="modal"  class="close" aria-label="Close" href="layoutsetting.php?layout=2&col=0&button=0" data-target="#settingModal"><div class="fa fa-gear"></div></a>-->
		<!--<a data-toggle="modal"  class="close" aria-label="Close" onclick="window.location.replace('<?php echo $_SERVER['REQUEST_URI'];?>&button=1');"  data-target="#settingModal"><div class="fa fa-gear"></div></a>-->
		 <!--<button type="button" value="button1" class="close" data-toggle="modal" data-target="#settingModal"><div class="fa fa-gear"></div></button>-->
	</div>
	<?php
	 $connectionstatus='<sub><div class="fa fa-close" style="color:#FF0000;" ></div></sub><div class="fa fa-database"></div>';
	 if ($xmlDoc->col1->dbconnected== '1'){
	  ...
	  ?>
		<a data-toggle="modal" class="close" aria-label="Close" href="dbsetting.php?layout=2&col=1" data-target="#dbModal-1"><?php echo $connectionstatus;?></a>
	</div>
	<div class="panel-body result">
			<?php echo $result[1];?>
	</div>
